    ...
    <div className="flex md:flex-wrap flex-wrap-reverse">
            ...
            <section className="space-y-6 pb-8 sm:pt-6 md:pb-12 md:pt-10 lg:py-32">
                <div className="container flex max-w-5xl flex-col items-center gap-4 text-center">
                    ...
                    <p className="max-w-2xl leading-normal sm:text-xl sm:leading-8">
                        Utilizamos inteligencia artificial para proporcionar una
                        evaluación en tiempo real del riesgo hídrico y
                        ofreciendo opciones de adaptación y mitigación
                    </p>
        ...
        <div className="w-full md:w-2/5">
            <div className="flex justify-center items-center h-full py-5 md:py-30">
                <Image
                    src="images/background/water_cycle_colored_boxed.svg"
                    alt="water cycle image"
                    width={100}
                    height={100}
                    className="max-w-sm md:max-w-lg w-3/5 md:w-auto"
                />
            </div>
        </div>
    </div>
